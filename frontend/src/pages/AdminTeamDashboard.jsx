...
|--------------------------------------------------------------------------
|
| Team members first select an event through the existing
| Team Lookup page.
|
| The lookup page then opens:
|
...
function AdminTeamDashboard() {
    ...
    /* =========================================================
       ...
       http://127.0.0.1:5000/uploads/events/image.jpg

       https://your-domain.com/uploads/events/image.jpg
    ...
    */
    ...
    ========================================================= */
      ...
      if (!eventId) {
          alert("No event has been assigned to you yet.");
          return;
      }
    ...
    const openTicketLookup = () => {
      ...
      Team members must NEVER use the public event route.
      ...
      This keeps the team member inside the Team Portal.
    */
        ...
        return (
            ...
            <div className="team-portal-page">
                ...
                <div className="team-portal-loading">
                    ...
                    <div className="team-portal-spinner"></div>
                            ...
                            <div className="team-assigned-event-body">
                                ...
                                <button
                                    ...
                                    onClick={(event) => {
                                        ...
                                        if (!eventId) {
                                            alert("This event does not have a valid event ID.");
                                            return;
                                        }
